...
#TODO: convert existing comments to docstrings for each function (use 
# autogenerated docstring format to stay consistent)
...
#TODO: make function for sleep time for main (code already exists)
